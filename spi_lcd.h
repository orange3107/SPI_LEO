...
void point(int x, int y, unsigned short usColor);
void lineV(int x, int y, int h, unsigned short usColor);
void fillRect(int x, int y, int w, int h, unsigned short usColor);
